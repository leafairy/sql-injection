...
if __name__ == '__main__':
    parser = optparse.OptionParser('usage: python %prog -u url \n\n'
                                   'Example: python %prog -u http://dd32a85d-4f80-4cbe-a490-44575a952918.node4.buuoj.cn:81/index.php\n')
    # 目标URL参数-u
    parser.add_option('-u', '--url', dest='targetURL', default='http://dd32a85d-4f80-4cbe-a490-44575a952918.node4.buuoj.cn:81/index.php', type='string',
                      help='target URL')
